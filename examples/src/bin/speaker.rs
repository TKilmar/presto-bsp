...
use presto_bsp::speaker::{NamedPitch, Note, SoftSpeaker};
use presto_bsp::{embassy_rp::gpio::{Level, Output}, Presto};
...
async fn main(_s: Spawner) {
    ...
    let mut speaker = SoftSpeaker::new(Output::new(board.speaker, Level::Low));
    loop {
